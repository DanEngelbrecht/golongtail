...
func upSyncVersion(
	...
	if sourceIndexPath == nil || len(*sourceIndexPath) == 0 {
		fileInfos, err := longtaillib.GetFilesRecursively(fs, Longtail_PathFilterAPI{}, sourceFolderPath)
		if err != nil {
			return err
		}
...
func downSyncVersion(
	...
	if targetIndexPath == nil || len(*targetIndexPath) == 0 {
		fileInfos, err := longtaillib.GetFilesRecursively(fs, Longtail_PathFilterAPI{}, targetFolderPath)
		if err != nil {
			return err
		}
		defer fileInfos.Dispose()
