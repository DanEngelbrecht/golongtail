...
rm *.o
gcc -c $GCC_EXTRA -std=gnu99 -m64 -O3 -pthread -msse4.1 -maes ../src/*.c ../src/ext/*.c ../lib/*.c $BIKESHED_SRC $BLAKE2_SRC $BLAKE3_SRC $FILESTORAGE_SRC $FSBLOCKSTORE_SRC $MEMSTORAGE_SRC $MEOWHASH_SRC $LIZARD_SRC $LZ4_SRC $BROTLI_SRC $ZLIB_SRC
popd
