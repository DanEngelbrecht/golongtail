...
gcc -c -std=gnu99 -m64 -O3 -pthread -Isrc -DWINVER=0x0A00 -D_WIN32_WINNT=0x0A00 ..\src\*.c ..\src\ext\*.c ..\lib\*.c %BIKESHED_SRC% %BLAKE2_SRC% %FILESTORAGE_SRC% %MEMSTORAGE_SRC% %LIZARD_SRC% %BROTLI_SRC%
