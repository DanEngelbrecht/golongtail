...
func writeStoreIndex(
	...
	storeIndexName := getPartialStoreIndexName(storeIndex)
	...
	for {
		...
		if exists && consolidatedStoreIndexName == storeIndexName {
			storeIndex.Dispose()
		...
		storeIndexName = consolidatedStoreIndexName
